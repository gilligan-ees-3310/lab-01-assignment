...
format_md(joules_per_day, digits = 2, format = "scientific")
```
...
1.23 &times; 10^7^
```
(note the `^` both before and after the exponent) 
or 
```
$1.23 \times 10^{7}$
```
...
after the first `\``, also note that we used the notation `1.23E7` for the 
